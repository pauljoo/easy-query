 ...
 */
public class MongoFilter extends Filter implements info.xpanda.dsl.server.mongodb.MongoRel {
    public MongoFilter(
    ...
    public void implement(Implementor implementor) {
        ...
        Translator translator =
                new Translator(implementor.rexBuilder,
                        info.xpanda.dsl.server.mongodb.MongoRules.mongoFieldNames(getRowType()));
    ...
    static class Translator {
        ...
        private boolean translateBinary2(String op, RexNode left, RexNode right) {
            ...
            switch (left.getKind()) {
                ...
                case ITEM:
                    String itemName = info.xpanda.dsl.server.mongodb.MongoRules.isItem((RexCall) left);
                    if (itemName != null) {
