...
//        return typeFactory.builder().add("_MAP", mapType).build();
    ...
    public RelNode toRel(
        ...
        return new info.xpanda.dsl.server.mongodb.MongoTableScan(cluster, cluster.traitSetOf(info.xpanda.dsl.server.mongodb.MongoRel.CONVENTION),
    ...
    private Enumerable<Object> find(MongoDatabase mongoDb, String filterJson,
        ...
        final Function1<Document, Object> getter = info.xpanda.dsl.server.mongodb.MongoEnumerator.getter(fields);
        return new AbstractEnumerable<Object>() {
            @Override
            public Enumerator<Object> enumerator() {
                @SuppressWarnings("unchecked") final FindIterable<Document> cursor =
                        collection.find(filter).projection(project);
                return new info.xpanda.dsl.server.mongodb.MongoEnumerator(cursor.iterator(), getter);
            }
        };
    }
    ...
    private Enumerable<Object> aggregate(final MongoDatabase mongoDb,
        ...
        final Function1<Document, Object> getter =
                info.xpanda.dsl.server.mongodb.MongoEnumerator.getter(fields);
        return new AbstractEnumerable<Object>() {
            @Override
            public Enumerator<Object> enumerator() {
                ...
                return new info.xpanda.dsl.server.mongodb.MongoEnumerator(resultIterator, getter);
            }
        };
    }
    ...
    public static class MongoQueryable<T> extends AbstractTableQueryable<T> {
        ...
        private MongoDatabase getMongoDb() {
            return schema.unwrap(info.xpanda.dsl.server.mongodb.MongoSchema.class).mongoDb;
        }
         ...
         *
         * @see info.xpanda.dsl.server.mongodb.MongoMethod#MONGO_QUERYABLE_AGGREGATE
         */
         ...
         * @see info.xpanda.dsl.server.mongodb.MongoMethod#MONGO_QUERYABLE_FIND
         */
        @SuppressWarnings("UnusedDeclaration")
