 ...
 * {@link info.xpanda.dsl.server.mongodb.MongoRel#CONVENTION} to {@link EnumerableConvention}.
 */
public class MongoToEnumerableConverterRule extends ConverterRule {
    ...
    public static final ConverterRule INSTANCE = Config.INSTANCE
            .withConversion(RelNode.class, info.xpanda.dsl.server.mongodb.MongoRel.CONVENTION,
    ...
    public RelNode convert(RelNode rel) {
        ...
        return new info.xpanda.dsl.server.mongodb.MongoToEnumerableConverter(rel.getCluster(), newTraitSet, rel);
    }
}
