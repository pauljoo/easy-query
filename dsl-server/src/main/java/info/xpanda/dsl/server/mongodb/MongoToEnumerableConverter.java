...
public class MongoToEnumerableConverter
    ...
    public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
        ...
        final info.xpanda.dsl.server.mongodb.MongoRel.Implementor mongoImplementor =
                new info.xpanda.dsl.server.mongodb.MongoRel.Implementor(getCluster().getRexBuilder());
        ...
        final Expression fields =
                list.append("fields",
                        constantArrayList(
                                Pair.zip(info.xpanda.dsl.server.mongodb.MongoRules.mongoFieldNames(rowType),
