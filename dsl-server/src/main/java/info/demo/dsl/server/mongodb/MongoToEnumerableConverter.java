...
public class MongoToEnumerableConverter
    ...
    public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
        ...
        final info.demo.dsl.server.mongodb.MongoRel.Implementor mongoImplementor =
                new info.demo.dsl.server.mongodb.MongoRel.Implementor(getCluster().getRexBuilder());
        ...
        final Expression fields =
                list.append("fields",
                        constantArrayList(
                                Pair.zip(info.demo.dsl.server.mongodb.MongoRules.mongoFieldNames(rowType),
