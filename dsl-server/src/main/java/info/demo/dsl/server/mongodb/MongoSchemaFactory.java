...
/**
 * Factory that creates a {@link info.demo.dsl.server.mongodb.MongoSchema}.
 *
...
public class MongoSchemaFactory implements SchemaFactory {
    ...
    public Schema create(SchemaPlus parentSchema, String name,
        ...
        return new info.demo.dsl.server.mongodb.MongoSchema(host, database, credential, options.build());
    }
