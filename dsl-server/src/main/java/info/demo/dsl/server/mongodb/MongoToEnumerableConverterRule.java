 ...
 * {@link info.demo.dsl.server.mongodb.MongoRel#CONVENTION} to {@link EnumerableConvention}.
 */
public class MongoToEnumerableConverterRule extends ConverterRule {
    ...
    public static final ConverterRule INSTANCE = Config.INSTANCE
            .withConversion(RelNode.class, info.demo.dsl.server.mongodb.MongoRel.CONVENTION,
    ...
    public RelNode convert(RelNode rel) {
        ...
        return new info.demo.dsl.server.mongodb.MongoToEnumerableConverter(rel.getCluster(), newTraitSet, rel);
    }
}
